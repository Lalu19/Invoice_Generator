( function ( $ ) {
	...
	gradientStroke1.addColorStop(0, '#0718c4');
	gradientStroke1.addColorStop(1, '#0718c4');
	...
	gradientStroke.addColorStop(0, '#0718c4');
	gradientStroke.addColorStop(1, '#0718c4');
    var myChart = new Chart( myCanvas, {
		type: 'line',
		data: {
